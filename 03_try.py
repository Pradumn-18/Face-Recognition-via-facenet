...
class Ui_Dialog(object):
    ...
    def database_fetch(self):
        ...
        w = Label(root,text='Employee ID ',font=("bold",12))
        m = Label(root,text=ourMessage,fg='blue',font=("bold",12))
        w1 = Label(root,text='ID No. ',font=("bold",12))
        m1 = Label(root,text=ourMessage1,fg='blue',font=("bold",12))
        w2 = Label(root,text='Name of Company ',font=("bold",12))
        m2 = Label(root,text=ourMessage2,fg='blue',font=("bold",12))
        w3 = Label(root,text='First Name ',font=("bold",12))
        m3 = Label(root,text=ourMessage3,fg='blue',font=("bold",12))
        w4 = Label(root,text='Surname ',font=("bold",12))
        m4 = Label(root,text=ourMessage4,fg='blue',font=("bold",12))
        w5 = Label(root,text='Date Of Birth ',font=("bold",12))
        m5 = Label(root, text=ourMessage5,fg='blue',font=("bold",12))
        w6 = Label(root,text='Father Name ',font=("bold",12))
        m6 = Label(root,text=ourMessage6,fg='blue',font=("bold",12))
        w7 = Label(root,text='Mother Name ',font=("bold",12))
        m7 = Label(root,text=ourMessage7,fg='blue',font=("bold",12))
        w8 = Label(root,text='Designation ',font=("bold",12))
        m8 = Label(root, text=ourMessage8,fg='blue',font=("bold",12))
        w9 = Label(root,text='Gender ',font=("bold",12))
        m9 = Label(root,text=ourMessage9,fg='blue',font=("bold",12))
        w10 = Label(root,text='Issue_Date ',font=("bold",12))
        m10 = Label(root,text=ourMessage10,fg='blue',font=("bold",12))
        w11 = Label(root,text='Valid_Upto ',font=("bold",12))
        m11 = Label(root,text=ourMessage11,fg='blue',font=("bold",12))
        w12 = Label(root,text='Address ',font=("bold",12))
        m12 = Label(root,text=ourMessage12,fg='blue',font=("bold",12)) 
        w13 = Label(root,text='Pincode ',font=("bold",12))
        m13 = Label(root,text=ourMessage13,fg='blue',font=("bold",12))
        w14 = Label(root,text='Contact ',font=("bold",12))
        m14 = Label(root,text=ourMessage14,fg='blue',font=("bold",12)) 
        w15 = Label(root,text='Email ',font=("bold",12))
        m15 = Label(root,text=ourMessage15,fg='blue',font=("bold",12))
        ...
        m.place(x=300,y=80)
        w1.place(x=85,y=110)
        m1.place(x=300,y=110)
        w2.place(x=85,y=140)
        m2.place(x=300,y=140)
        w3.place(x=85,y=170)
        m3.place(x=300,y=170)
        w4.place(x=85,y=200)
        m4.place(x=300,y=200)
        w5.place(x=85,y=230)
        m5.place(x=300,y=230)
        w6.place(x=85,y=260)
        m6.place(x=300,y=260)
        w7.place(x=85,y=290)
        m7.place(x=300,y=290)
        w8.place(x=85,y=320)
        m8.place(x=300,y=320)
        w9.place(x=85,y=350)
        m9.place(x=300,y=350)
        w10.place(x=85,y=380)
        m10.place(x=300,y=380)
        w11.place(x=85,y=410)
        m11.place(x=300,y=410)
        w12.place(x=85,y=440)
        m12.place(x=300,y=440)
        w13.place(x=85,y=470)
        m13.place(x=300,y=470)
        w14.place(x=85,y=500)
        m14.place(x=300,y=500)
        w15.place(x=85,y=530)
        m15.place(x=300,y=530)
    ...
    def form(self):
        ...
        def myfunction(event):
            canvas.configure(scrollregion=canvas.bbox("all"),width=920,height=900)
            
        myframe=Frame(root,width=920,height=900,bd=1)
